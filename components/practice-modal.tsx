...
export function PracticeModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-0 bg-black/50 backdrop-blur-sm">
            {/* Modal Container - Full screen on all devices */}
            <div className="bg-white dark:bg-gray-900 w-full h-full flex flex-col overflow-hidden">
                ...
                <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-teal-50 to-blue-50 dark:from-teal-900/20 dark:to-blue-900/20">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                            Practice Sentence
                            {totalSentences > 1 && currentIndex >= 0 && (
                                <span className="text-xs font-semibold bg-white/50 dark:bg-black/20 text-teal-700 dark:text-teal-300 px-2 py-0.5 rounded-full">
                ...
                <div className="flex-1 overflow-y-auto p-4 sm:p-6">
                    <div className="max-w-3xl mx-auto w-full pb-32 space-y-6">
                        {/* Toggle Controls */}
                                ...
                                <div className="text-center py-8 space-y-4 flex flex-col items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 dark:text-gray-500 mb-6">
                                            Click the button below to generate a new sentence with AI
                                        </p>
                                    </div>
                                    <Button
                                        onClick={onGenerateNew}
                        ...
                        {practiceSentence && practiceSentence.ja && (
                            <div className="space-y-3 pt-4">
                                ...
                                {/* Helper text */}
                                <div className="text-xs text-gray-500 dark:text-gray-400 text-center space-x-3 pt-2">
                                    <span>
