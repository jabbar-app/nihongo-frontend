                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed inset-x-4 bottom-24 md:inset-auto md:bottom-24 md:right-8 md:w-96 flex flex-col max-h-[80vh] bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-700"
                            style={{ zIndex: 70 }}
                        >
                            {/* Header / Search */}
